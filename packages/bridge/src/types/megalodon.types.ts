...
import type { ScheduledStatus as MLScheduledStatus } from 'megalodon/lib/esm/src/entities/scheduled_status.js';
...
export type MegaScheduledStatus = MLScheduledStatus;
