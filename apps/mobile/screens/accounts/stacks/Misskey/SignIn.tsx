...
function MisskeySignInStack({route, navigation}) {
  ...
  async function onPressConfirm() {
    db.write(() => {
      ...
      AccountRepository.setSecret(db, acct, "display_name", PreviewCard.displayName)
                    ...
                    <View style={{
                      ...
                      <View style={{
                        ...
                        <View style={{flexShrink: 1, minWidth: 24}}>
                          <FontAwesome
                              name="check-square" size={24}
                              color={"linear-gradient(90deg, rgb(0, 179, 50), rgb(170," +
                                  " 203, 0))"}
                          />
                        </View>
                        <Text>Your session has been confirmed.</Text>
                      </View>
                      <View style={{
                        display: "flex",
                        flexDirection: "row",
                        ...
                        <View>
                          <Text style={{textAlign: "left"}}>Confirm that you
                            want to use this account.</Text>
                        </View>
                      </View>
                    </View>
                ) : (
