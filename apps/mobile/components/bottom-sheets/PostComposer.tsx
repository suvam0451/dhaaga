...
function PostComposerActionSheet({visible, setVisible}: StatusActionsProps) {
  ...
  return <BottomSheet
      ...
      backgroundComponent={(props) => <BottomSheetBackdrop
      ...
      <ListItem containerStyle={{
        ...
        <View style={{display: "flex", flexDirection: "row"}}>
          <TouchableOpacity onPress={handleExpoFilePicker}>
            <FontAwesome
                name="image" size={24} color="#fff"/>
          </TouchableOpacity>
          <FontAwesome
              name="warning" size={24} color="#fff"
              style={{marginLeft: 16}}/>
          <FontAwesome6
              name="smile" size={24} color="#fff"
              style={{marginLeft: 16}}/>
        </View>
      </ListItem>
      <ListItem containerStyle={{
...
export default PostComposerActionSheet;