...
import CustomTimelineOptions from '../scenes/5_Custom';
import { SceneMap } from 'react-native-tab-view';
import TimelineWidgetUserScene from '../scenes/4_User';

const renderScene = SceneMap({
	pinned: DefaultTimelineOptions,
	lists: ListTimelineOptions,
	tags: HashtagTimelineOptions,
	users: TimelineWidgetUserScene,
	custom: CustomTimelineOptions,
});
