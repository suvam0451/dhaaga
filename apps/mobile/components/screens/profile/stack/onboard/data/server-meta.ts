/**
 * Use this file to add your server
 * to the list of servers recommended inside
 * Dhaaga
 *
 * - Active Server
 * - No NSFW as sole focus
 * - Final decision by developer
 *
 * Users can log into any server (does not
 * need to be listed here)
 *
 * It is just for quick use ;)
 */
...
export const POPULAR_SHARKEY_SERVERS = [
	{ value: 'blahaj.zone', label: 'blahaj.zone' },
	{ value: 'lethallava.land', label: 'lethallava.land' },
	{ value: 'transfem.social', label: 'transfem.social' },
	{ value: 'mk.absturztau.be', label: '🇬🇧 mk.absturztau.be' },
];

export const POPULAR_FIREFISH_SERVERS = [
