...
import {
  GetPostsQueryDTO
} from "@dhaaga/shared-abstraction-activitypub/src/adapters/_client/_interface";
...
class ActivityPubProviderService {
  ...
  static async getTimeline(client: ActivityPubClient, mode: TimelineFetchMode, opts: GetPostsQueryDTO, misc: TimelineGetMiscQueryDto) {
    if (!client) return []
